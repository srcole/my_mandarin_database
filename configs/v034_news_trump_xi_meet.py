...
video_name = 'Trump-Xi October 2025 meeting: Chinese listening practice with the news (+English translations)'
video_description = '''
...
data_settings = {
    'recording_id': 'conly',
    'filename_suffix': 'news_trumpxi_meet',
    'voice_name_zh': 'zh-CN-XiaoyuMultilingualNeural',
    # 'voice_name_zh': 'zh',
    'different_file_name': 'static/texts/news/20251031_trump_xi_meeting.csv',
    'sort_keys': ['index'],
    'sort_asc': [True],
...
video_configs = {
    ...
    'icon_configs': {
        ...
        'word': '不少分析人士认为，北京这次获得了关键筹码。', # UPDATE ON NEW VIDEO
...
subtitle = {
    'chinese': '特朗普-习近平会晤',
    'pinyin': 'tèlǎngpǔ-xíjìnpíng huìwù',
    'english': 'Trump-Xi meeting',
    }  # UPDATE ON NEW VIDEO
nonvocab_slides = {
    'intro': {
