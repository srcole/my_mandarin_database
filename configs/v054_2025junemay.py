...
video_name = '404 Chinese vocab words/phrases of the month (May-June 2025) + example sentences & character breakdown [Dark Mode]'
video_description = '''
...
data_settings = {
    ...
    'filename_suffix': '2025junemay_words',
...
subtitle = {
    'chinese': '我2025年5-6月的新词汇',
    'pinyin': 'wǒ 2025 nián 5-6 yuè de xīn cíhuì',
    'english': 'My new May-June 2025 vocabulary',
    }  # UPDATE ON NEW VIDEO
...
nonvocab_slides = {
    ...
    'outro': {
        ...
        'col_space_big': 0,
        'definition_configs':{
            'chinese': {'x_offset': 0, 'x_max': 62, 'font_path': hanzi_font_path},
            'english': {'x_offset': None, 'x_max': 120, 'font_path': hanzi_font_path},
        }
    }
}
