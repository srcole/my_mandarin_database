...
video_name = '89 China tourist attraction names + example sentences & character breakdown'
video_description = '''
...
subtitle = {
    'chinese': '中国旅游景点',
    'pinyin': 'zhōngguó lǚyóu jǐngdiǎn',
    'english': 'Chinese tourist attractions',
    }  # UPDATE ON NEW VIDEO
