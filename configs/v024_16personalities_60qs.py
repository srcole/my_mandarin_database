...
video_name = '16 Personalities test: 60 questions in Chinese with English translations'
video_description = '''
This video was made to practice both listening comprehension and character recognition.
The Chinese is spoken twice, with the English translation shown in the video.
...
video_number = '24'
data_settings = {
    'recording_id': 'chinese_only_word_twice',
    'filename_suffix': '16personalities_60qs',
    'different_file_name': 'static/texts/lists/16personalities_translate_goodcomma.csv',
    'custom_filters': [
...
video_configs = {
    ...
    'icon_configs': {
        ...
        'word': '你的情绪变化得非常快。', # UPDATE ON NEW VIDEO
...
subtitle = {
    'chinese': '60个问题测试16种性格',
    'pinyin': '60 gè wèntí cèshì 16 zhǒng xìnggé',
    'english': '60 questions to test 16 personalities'
    }  # UPDATE ON NEW VIDEO
nonvocab_slides = {
    'intro': {
        ...
        'video_structure': ('Chinese spoken twice', '讲了两次中文'),
    ...
    'outro': {
        ...
        'col_space_big': 10,
        'definition_configs':{
            'chinese': {'x_offset': 0, 'x_max': 240, 'font_path': hanzi_font_path},
            'english': {'x_offset': None, 'x_max': 370, 'font_path': hanzi_font_path},
        },
    }
}
