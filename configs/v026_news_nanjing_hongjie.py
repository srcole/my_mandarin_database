...
video_name = 'Nanjing Sister Hong: Chinese listening practice with the news (+English translations)'
video_description = '''
...
data_settings = {
    'recording_id': 'conly',
    'filename_suffix': 'news_nanjing_hongjie',
    'voice_name_zh': 'zh-CN-XiaoyuMultilingualNeural',
    # 'voice_name_zh': 'zh',
    'different_file_name': 'static/texts/news/20251023_nanjing_hongjie.csv',
    'sort_keys': ['index'],
    'sort_asc': [True],
...
video_configs = {
    ...
    'icon_configs': {
        ...
        'word': '受害者中包括健身教练、大学生、外籍人士等，年龄层次不一。', # UPDATE ON NEW VIDEO
...
subtitle = {
    'chinese': '南京红姐事件',
    'pinyin': 'nánjīng hóng jiě shìjiàn',
    'english': 'Nanjing Hong sister incident'
    }  # UPDATE ON NEW VIDEO
nonvocab_slides = {
    'intro': {
