...
video_name = '98 color words in Chinese + example sentences in 12 minutes'
video_description = '''
...
data_settings = {
    ...
    'filename_suffix': 'colors',
    'max_priority': 5,
    'cat_v3_allowed': ['my_colors'],
...
nonvocab_slides = {
    ...
    'outro': {
        ...
        'definition_configs':{
            ...
            'english': {'x_offset': None, 'x_max': 220, 'font_path': hanzi_font_path},
        }
    }
}
