...
video_name = '27 Chinese vocabulary words with 电 (+ example sentences)'
video_description = '''
...
data_settings = {
    ...
    'filename_suffix': 'char_电',
    'pause_start_ms': 100,
    'contains_character': '电',
    'exclude_words': ['中国电信', '科幻电影'],
...
subtitle = {
    'chinese': '有“电”字的词',
    'pinyin': 'yǒu “diàn” zì de cí',
    'english': 'Words with "electricity"'
    }  # UPDATE ON NEW VIDEO
nonvocab_slides = {
    'intro': {
