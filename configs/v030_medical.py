...
video_name = '131 medical Chinese vocabulary (+Example sentences) in 16 minutes'
video_description = '''
...
data_settings = {
    ...
    'filename_suffix': 'medical',
    'types_allowed': WORD_TYPES + PROPER_NOUN_TYPES,
    'max_priority': 5,
    'min_adu': 3,
    'min_per': 3,
    'sort_keys': ['priority', 'category1', 'category2', 'pinyin'],
    'sort_asc': [True, True, False, True],
    'categories2_allowed': ['medical dept', 'other', 'reproductive health', 'staff', 'supplies', 'treatments'],
}
...
nonvocab_slides = {
    ...
    'word_list': {
        ...
        'definition_configs':{
            ...
            'pinyin': {'x_offset': None, 'x_max': 110, 'font_path': hanzi_font_path},
