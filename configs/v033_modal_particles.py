...
video_name = '25 modal particles (speaking sounds to express emotion) in Chinese language (+Example sentences)'
video_description = '''
...
data_settings = {
    ...
    'filename_suffix': 'modal_particles',
    'types_allowed': ['modal particle'],
    'max_priority': 3,
    'min_adu': 3,
    'min_per': 3,
...
nonvocab_slides = {
    ...
    'word_list': {
        'chinese_unfill': '{audio_duration_minutes:.0f}分钟, {n_vocab}个词',
        'pinyin_unfill': '{audio_duration_minutes:.0f} fēnzhōng, {n_vocab} gè cí',
        ...
        'definition_configs':{
            ...
            'pinyin': {'x_offset': None, 'x_max': 80, 'font_path': hanzi_font_path},
            'english': {'x_offset': None, 'x_max': 470, 'font_path': hanzi_font_path},
        },
    },
