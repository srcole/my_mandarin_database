...
video_name = 'All 34 China province-level regions: translated name meanings + example sentences in 3 minutes'
video_description = '''
...
data_settings = {
    ...
    'filename_suffix': 'china_provinces',
    'max_priority': 7,
    'source1_values_allowed': ['China provinces'],
    'sort_keys': ['id'],
    'sort_asc': [True],
}
...
subtitle = {
    'chinese': '中国省级区域',
    'pinyin': 'zhōngguó shěng jí qūyù',
    'english': 'China province-level regions',
    } 
video_structure_tup = ('Chinese spoken only\nExample Chinese sentences', '就说中文\n并附中文例句')
count_str_tup = ("{n_vocab_words} regions", "{n_vocab_words}个地区")
nonvocab_slides = {
    'intro': {
    ...
    'outro': {
        ...
        'col_space_big': 20,
        'definition_configs':{
            'chinese': {'x_offset': 0, 'x_max': 130, 'font_path': hanzi_font_path},
            'pinyin': {'x_offset': None, 'x_max': 240, 'font_path': hanzi_font_path},
            'english': {'x_offset': None, 'x_max': 240, 'font_path': hanzi_font_path},
        }
    }
}
