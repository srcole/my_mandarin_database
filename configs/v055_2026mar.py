...
video_name = '97 Chinese vocab words/phrases of the month (Mar 2026) + example sentences & literal translations'
video_description = '''
...
subtitle = {
    'chinese': '我2026年3月的新词汇',
    'pinyin': 'wǒ 2026 nián 3 yuè de xīn cíhuì',
    'english': 'My new March 2026 vocabulary',
    }  # UPDATE ON NEW VIDEO
...
nonvocab_slides = {
    ...
    'outro': {
        ...
        'definition_configs':{
            ...
            'english': {'x_offset': None, 'x_max': 320, 'font_path': hanzi_font_path},
        }
    }
}
