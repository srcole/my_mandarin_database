...
video_name = '104 Chinese vocab words/phrases of the month (Feb 2026) + example sentences & character breakdown [Dark Mode]'
video_description = '''
...
subtitle = {
    'chinese': '我2026年2月的新词汇',
    'pinyin': 'wǒ 2026 nián 2 yuè de xīn cíhuì',
    'english': 'My new February 2026 vocabulary',
    }  # UPDATE ON NEW VIDEO
