...
video_name = 'HSK2 audio flash cards with 736 dual-language example sentences'
video_description = '''
...
subtitle = {
    'chinese': 'HSK2级音频卡片,含英语句子翻译',
    'pinyin': 'HSK2 jí yīnpín kǎpiàn, hán yīngyǔ jùzǐ fānyì',
