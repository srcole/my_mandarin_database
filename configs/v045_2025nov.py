...
video_name = '354 Chinese vocab words/phrases of the month (Nov 2025) + example sentences & character breakdown'
video_description = '''
...
data_settings = {
    ...
    'filename_suffix': '2025nov_words',
    'types_allowed': NON_SENTENCE_TYPES,
    'max_priority': 5,
    'min_known_english_prompt': 2,
    'cat2_v3_not_allowed': ['china_cities', 'china_provinces'],
    'min_date': '2025-11-01',
    'max_date': '2025-12-01',
}
...
subtitle = {
    'chinese': '我2025年11月的新词汇',
    'pinyin': 'wǒ 2025 nián 11 yuè de xīn cíhuì',
