...
video_name = '497 HSK1 audio flash cards with example Chinese sentences (#1-50)'
video_description = '''
...
subtitle = {
    'chinese': 'HSK1级音频卡片, 第一部分',
    'pinyin': 'HSK1 jí yīnpín kǎpiàn, dìyī bùfèn',
    'english': 'HSK1 audio flashcards, part 1'
    }  # UPDATE ON NEW VIDEO
nonvocab_slides = {
    'intro': {
