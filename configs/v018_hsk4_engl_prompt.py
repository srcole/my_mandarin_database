...
video_name = 'HSK4 audio flash cards with 994 dual-language example sentences in 4 hours'
video_description = '''
...
video_number = '18'
data_settings = {
    'recording_id': 'cce_cecsent',
    'filename_suffix': 'hsk4_eprompt',
...
subtitle = {
    'chinese': 'HSK4级音频卡片,含英语句子翻译',
    'pinyin': 'HSK4 jí yīnpín kǎpiàn, hán yīngyǔ jùzǐ fānyì',
