...
video_name = '80 of the largest Chinese cities: translated name meanings + example sentences in 7 minutes'
video_description = '''
...
data_settings = {
    ...
    'max_priority': 7,
    'source1_values_allowed': ['China cities'],
    'sort_keys': ['id'],
    'sort_asc': [True],
}
...
subtitle = {
    'chinese': '中国大陆城市',
    'pinyin': 'zhōngguó dàlù chéngshì',
    'english': 'Mainland Chinese Cities',
    } 
video_structure_tup = ('Chinese spoken only\nExample Chinese sentences', '就说中文\n并附中文例句')
count_str_tup = ("{n_vocab_words} cities", "{n_vocab_words}座城市")
nonvocab_slides = {
    'intro': {
    ...
    'outro': {
        ...
        'definition_configs':{
            ...
            'pinyin': {'x_offset': None, 'x_max': 160, 'font_path': hanzi_font_path},
