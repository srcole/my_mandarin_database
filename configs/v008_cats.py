...
video_name = '34 cat-related Chinese vocabulary + example sentences in 4 minutes'
video_description = '''
This video was made for quickly reviewing cat-related Chinese vocabulary, practicing both listening comprehension and character recognition.
...
subtitle = {'chinese': '猫词汇及例句', 'pinyin': 'Māo cíhuì jí lìjù', 'english': 'Cat vocabulary with example sentences'}
nonvocab_slides = {
    'intro': {
