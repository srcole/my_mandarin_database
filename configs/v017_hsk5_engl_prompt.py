...
subtitle = {
    'chinese': 'HSK5级音频卡片,含英语句子翻译',
    'pinyin': 'HSK5 jí yīnpín kǎpiàn, hán yīngyǔ jùzǐ fānyì',
    'english': 'HSK5 audio flashcards'
    }  # UPDATE ON NEW VIDEO
nonvocab_slides = {
    'intro': {
