...
video_name = '43 Mario words - Chinese vocabulary'
video_description = '''
This video was made for quickly reviewing Chinese vocabulary related to Mario, practicing both listening comprehension and character recognition.
...
data_settings = [
    {
    'recording_id': 'ceword_csent',
    'filename_suffix': '_mario',
    'min_priority': 1, 'max_priority': 4,
    'categories2_allowed': ['mario party', 'mario kart', 'mario character'],
...
subtitle_1 = {'chinese': '马里奥词汇', 'pinyin': 'Mǎlǐào cíhuì', 'english': 'Mario vocabulary'}
subtitle_2 = {'chinese': '附例句', 'pinyin': 'fù lìjù', 'english': 'example sentences'}
nonvocab_slides = {
    'intro': {
    ...
    'word_list': {
        ...
        'definition_configs':{
            ...
            'english': {'x_offset': None, 'x_max': 270, 'font_path': hanzi_font_path},
        },
    },
