...
subtitle = {
    'chinese': '机密暗号游戏词',
    'pinyin': 'jīmì ànhào yóuxì cí',
    'english': 'Codenames game words',
    }  # UPDATE ON NEW VIDEO
...
nonvocab_slides = {
    ...
    'outro': {
        ...
        'definition_configs':{
            ...
            'pinyin': {'x_offset': None, 'x_max': 66, 'font_path': hanzi_font_path},
            'english': {'x_offset': None, 'x_max': 70, 'font_path': hanzi_font_path},
        }
    }
}
