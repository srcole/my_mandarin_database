...
video_name = 'x Chinese vocab words/phrases of the month (Jan 2026) + example sentences & character breakdown [Dark Mode]'
video_description = '''
...
subtitle = {
    'chinese': '我2026年1月的新词汇',
    'pinyin': 'wǒ 2026 nián 1 yuè de xīn cíhuì',
    'english': 'My new January 2026 vocabulary',
    }  # UPDATE ON NEW VIDEO
