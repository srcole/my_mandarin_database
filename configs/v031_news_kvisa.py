...
video_name = 'China K Visa and public reaction: Chinese listening practice with the news (+English translations)'
video_description = '''
...
data_settings = {
    'recording_id': 'conly',
    'filename_suffix': 'news_kvisa',
    'voice_name_zh': 'zh-CN-XiaoyuMultilingualNeural',
    # 'voice_name_zh': 'zh',
    'different_file_name': 'static/texts/news/20251028_kvisa.csv',
    'sort_keys': ['index'],
    'sort_asc': [True],
...
video_configs = {
    ...
    'icon_configs': {
        ...
        'word': '在这样背景下，K 签证被许多人视作“引进外人抢饭碗”。', # UPDATE ON NEW VIDEO
...
subtitle = {
    'chinese': '中国新K签证',
    'pinyin': 'zhōngguó xīn K qiānzhèng',
    'english': 'Chinese new K visa'
    }  # UPDATE ON NEW VIDEO
nonvocab_slides = {
    'intro': {
