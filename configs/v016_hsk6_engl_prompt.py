...
video_name = '1134 HSK6 Chinese + English audio flash cards with full dual-language audio'
video_description = '''
...
subtitle = {
    'chinese': 'HSK6级音频卡片,含英语句子翻译',
    'pinyin': 'HSK6 jí yīnpín kǎpiàn, hán yīngyǔ jùzǐ fānyì',
