...
video_name = 'HSK1 audio flash cards with 497 dual-language example sentences'
video_description = '''
...
subtitle = {
    'chinese': 'HSK1级音频卡片,含英语句子翻译',
    'pinyin': 'HSK1 jí yīnpín kǎpiàn, hán yīngyǔ jùzǐ fānyì',
